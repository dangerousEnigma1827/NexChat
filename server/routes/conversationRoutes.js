...
import { conversationAdd, getAllConversations, getAllMessagesOfAConversation, getAllSingleUsers, createNewGroup, getAllCommonGroups, clickedConversation, setAllConversationToSeen} from '../controllers/conversationControllers.js';
...
router.post('/setSeen', protectRoute, setAllConversationToSeen)
