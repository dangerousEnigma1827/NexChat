        ...
        <div className='w-[28vw] rounded-2xl bg-[#232a3a] border border-[#31384d] shadow-2xl p-8'>
            ...
            <div className='flex flex-col items-center text-center text-white'>
                ...
                <div className='flex gap-4 w-full'>
                    ...
                    <button
                        className='flex-1 py-3 rounded-xl bg-[#2b3142] hover:bg-[#3b4258] transition-all duration-200'
                        onClick={()=>{
                    ...
                    <button
                        className='flex-1 py-3 rounded-xl bg-red-500 hover:bg-red-600 transition-all duration-200 font-medium'
                        onClick={()=>{
...
export default DeleteForMePopup